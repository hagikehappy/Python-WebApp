...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/media/hagikehappy/LinuxData/Programmes/Python/Book/SelfWrite/Web_App/ll_env'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/media/hagikehappy/LinuxData/Programmes/Python/Book/SelfWrite/Web_App/ll_env/bin/deactivate.nu'
